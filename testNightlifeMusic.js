...
describe('All intents', function() {
  ...
  for(var key in expResults) {
    ...
    describe(`Test GetNightlifeMusic ${key}`, function() {
        var options = expResults[key];
        var testNightlifeMusic = key;
        ...
        before(function(done) {
          ...
          event.request.intent.name = 'GetNightlifeMusic';
          event.request.intent.slots = {
            NightlifeMusic: {
              name: 'NightlifeMusic',
              value: testNightlifeMusic
            }
          };
          ctx.done = done;
          lambdaToTest.handler(event , ctx);
    ...
    if (!expResults[key].endSession) {
      ...
      describe(`Test GetNextMusicIntent ${key}`, function() {
          var options = expResults[key];
          var testNightlifeMusic = key;
          ...
          before(function(done) {
            ...
            event.request.type = 'IntentRequest';
            event.request.intent.name = 'GetNextMusicIntent';
            event.request.intent.slots = {};
            ctx.done = done;
            lambdaToTest.handler(event , ctx);
          });
  ...
  describe(`Test GetNightlifeMusic empty slot`, function() {
