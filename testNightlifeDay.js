...
describe('All intents', function() {
  ...
  for(var key in expResults) {
    ...
    describe(`Test GetNightlifeDay ${key}`, function() {
        var options = expResults[key];
        var testNightlifeDay = key;
        ...
        before(function(done) {
          ...
          event.request.intent.name = 'GetNightlifeDay';
          event.request.intent.slots = {
            NightlifeDay: {
              name: 'NightlifeDay',
              value: testNightlifeDay
            }
          };
          ctx.done = done;
          lambdaToTest.handler(event , ctx);
    ...
    if (!expResults[key].endSession) {
      ...
      describe(`Test GetNextDayIntent ${key}`, function() {
          var options = expResults[key];
          var testNightlifeDay = key;
          ...
          before(function(done) {
            ...
            event.request.type = 'IntentRequest';
            event.request.intent.name = 'GetNextDayIntent';
            event.request.intent.slots = {};
            ctx.done = done;
            lambdaToTest.handler(event , ctx);
          });
  ...
  describe(`Test GetNightlifeDay empty slot`, function() {
