...
describe('All intents', function() {
  ...
  for(var key in expResults) {
    ...
    describe(`Test GetNightlifeType ${key}`, function() {
        var options = expResults[key];
        var testNightlifeType = key;
        ...
        before(function(done) {
          ...
          event.request.intent.name = 'GetNightlifeType';
          event.request.intent.slots = {
            NightlifeType: {
              name: 'NightlifeType',
              value: testNightlifeType
            }
          };
          ctx.done = done;
          lambdaToTest.handler(event , ctx);
    ...
    if (!expResults[key].endSession) {
      ...
      describe(`Test GetNextNightlifeIntent ${key}`, function() {
          var options = expResults[key];
          var testNightlifeType = key;
          ...
          before(function(done) {
            ...
            event.request.type = 'IntentRequest';
            event.request.intent.name = 'GetNextNightlifeIntent';
            event.request.intent.slots = {};
            ctx.done = done;
            lambdaToTest.handler(event , ctx);
          });
  ...
  describe(`Test GetNightlifeType empty slot`, function() {
